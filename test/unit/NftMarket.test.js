...
describe('NFTMarket', function () {
  ...
  describe('createMarketSale', () => {
    ...
    it('should create the sale of a marketplace item', async () => {
      ...
      await expect(nftMarket.createMarketSale(nftContractAddress, 1, { value: offerPrice })).not.to.be.reverted;
    });

    it('should not create the sale of a marketplace item if the price is not the same asking asking price', async () => {
