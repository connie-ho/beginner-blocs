...
/* Class bc for BlockChain. Declare the shared, thread-safe UVB queue. Multicast the public key.

   Create sample UVBs and multicast them..
   Consume the UVBs as we perform verification on them with WORK.

   Create a new BlockChain when we verify a UVB.
   Multicast the new blockchain to other processes.
*/
